            ...
            [
                [
                    InlineKeyboardButton(
                        "🎉 𝖡𝖾𝗇𝗂 𝖦𝗋𝗎𝖻𝖺 𝖤𝗄𝗅𝖾 🎉", url=f"http://t.me/hababam_sinifibot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "🇹🇷 𝖲𝖺𝗁𝗂𝗉", url="https://t.me/hababammsinifi"
                    )
                ]
      ...
      reply_markup=InlineKeyboardMarkup(
             [
                 [
                     ...
                     InlineKeyboardButton(
                         "📩 𝐒𝐚𝐡𝐢𝐩", url="https://t.me/hababammsinifi")
                 ]
             ]
         )
    )
...
async def admin(_, query: CallbackQuery):
    ...
    reply_markup=InlineKeyboardMarkup(
             [
                 [
                     InlineKeyboardButton(
                         "⚙ Geliştirici", url="https://t.me/hababammsinifi")
                 ],
                 [
                     InlineKeyboardButton(
